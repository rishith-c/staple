...
import { readStapleSkillSyncPreference, writeStapleSkillSyncPreference } from "@stapleai/adapter-utils/server-utils";
    ...
    for (const agent of agentRows) {
      ...
      if (referencesSkill) {
        ...
        await agents.update(agent.id, {
          adapterConfig: writeStapleSkillSyncPreference(config, filtered),
        });
      }
    }
