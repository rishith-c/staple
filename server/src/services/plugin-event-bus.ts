/**
 * PluginEventBus — typed in-process event bus for the Staple plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@stapleai/shared";
import type { PluginEvent, EventFilter } from "@stapleai/plugin-sdk";
