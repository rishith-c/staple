 ...
 */
import type { CompanyPortabilityManifest } from "@stapleai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Staple](https://staple.ing)");
  lines.push("");
