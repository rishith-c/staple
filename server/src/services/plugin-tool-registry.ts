...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@stapleai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: StaplePluginManifestV1, pluginDbId?: string): void;
