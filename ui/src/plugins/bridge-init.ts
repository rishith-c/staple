 ...
 *
 * This is placed on `globalThis.__staplePluginBridge__` and consumed by
...
declare global {
  ...
  var __staplePluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__staplePluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__staplePluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
