...
Eval framework for testing Staple agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Staple heartbeat skill:
