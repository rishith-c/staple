...
Run the full Staple maintainer release workflow, not just an npm publish.
...
Staple now uses a commit-driven release model:
...
- release summary in Staple issue context
