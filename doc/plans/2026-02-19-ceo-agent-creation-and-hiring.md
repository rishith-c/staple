...
- installed adapter list for this Staple instance
...
## 8. New Skill: `staple-create-agent`

Create new skill directory:

- `skills/staple-create-agent/SKILL.md`
...
Also update `skills/staple/SKILL.md` to reference this skill for hiring workflows.
...
- `staple-create-agent` skill + docs updates
