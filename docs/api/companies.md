...
Manage companies within your Staple instance.
...
Company logo uploads use the normal Staple attachment size limit.
...
| `logoUrl` | string | Optional Staple asset content path for the stored logo image |
