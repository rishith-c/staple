...
- Running a Python script that calls the Staple API
...
1. Staple spawns the configured command as a child process
2. Standard Staple environment variables are injected (`STAPLE_AGENT_ID`, `STAPLE_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Staple API and perform work.
