...
For local CLI adapters (`claude_local`, `codex_local`, `opencode_local`, `hermes_local`), Staple assumes the CLI is already installed and authenticated on the host machine.
