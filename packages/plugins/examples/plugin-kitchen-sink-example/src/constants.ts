import type { PluginLauncherRegistration } from "@stapleai/plugin-sdk";

export const PLUGIN_ID = "staple-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".staple-kitchen-sink-demo.txt",
} as const;
