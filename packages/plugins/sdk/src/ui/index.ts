/**
 * `@stapleai/plugin-sdk/ui` — Staple plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@stapleai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@stapleai/plugin-sdk/ui";
 *
