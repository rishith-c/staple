...
import type { PluginCategory, PluginStatus, StaplePluginManifestV1 } from "@stapleai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<StaplePluginManifestV1>().notNull(),
