...
Use when:
- You want Staple to run Pi (the AI coding agent) locally as the agent runtime
...
- Staple requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/staples/ and resumed with --session.
